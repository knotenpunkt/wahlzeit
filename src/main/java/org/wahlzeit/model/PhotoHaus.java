...
public class PhotoHaus extends Photo implements Serializable {
	...
	public void addRoom(Room r) {
		...
		// Frage ist es allgemein besser, die Room-Liste zurueckzugeben und
		// darauf dann zu arbeiten,
		// oder die interne Implementierung zu verstecken und nur ueber
		// wohldefinierte Schnittstellen nach ausen zu geben
		// -> information-hiding Prinzip aus der OOP waere damit erfuellt.
		// Meiner Meinung nach wird das ganze aber dann ziemlich "nervig", wenn
		// man die interne Funktionalitaet beibehalten moechte
		// und nach aussen gibt ueber ganz viele solcher methoden, also so ne
		// Art redundante Methoden "addRoom -> add von liste",
		// "removeRoom -> remove von liste", "removeAll -> clear auf liste",
		// usw...
		// Man muss ganz vieles redundant bzw. deligierend programmieren. Kann
		// das wirklich Sinn der Sache sein, nur um
	...
	private long calcGesamtHausVolumen() {
		// private und helper, weil eventuell wo anders noch eine derartige
